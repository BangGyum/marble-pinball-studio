...
export type StageDef = {
  title: string;
  art?: { style: 'rapids' | 'jackpot' | 'pinball-cascade' | 'clocktower' | 'orbital-lock' | 'hourglass' | 'fracture-canyon' | 'crossway'; contours: [number, number][][]; arrows?: [number, number, number][] };
